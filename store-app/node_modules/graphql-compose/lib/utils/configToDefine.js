...
function defineFieldMap(config, fieldMap, parentAstNode) {
  ...
  for (const fieldName of Object.keys(fieldMap)) {
    ...
    const fieldNodeAst = parentAstNode === null || parentAstNode === void 0 ? void 0 : (_parentAstNode$fields = parentAstNode.fields) === null || _parentAstNode$fields === void 0 ? void 0 : _parentAstNode$fields.find(f => f.name.value === fieldName);
    ...
    if (!argsConfig) {
      ...
      field.args = Object.keys(argsConfig).map(argName => {
        ...
        return {
          ...
          // $FlowFixMe
          astNode: fieldNodeAst === null || fieldNodeAst === void 0 ? void 0 : (_fieldNodeAst$argumen = fieldNodeAst.arguments) === null || _fieldNodeAst$argumen === void 0 ? void 0 : _fieldNodeAst$argumen.find(a => a.name.value === argName)
        };
      });
    }
  ...
  Object.keys(_fields).forEach(n => {
    ...
    if (Array.isArray(fc.args)) {
      ...
      Object.keys(fc.args).forEach(argName => {
        args[argName] = _objectSpread(_objectSpread({}, (0, _is.isObject)(fc.args[argName]) ? fc.args[argName] : null), {}, {
          type: isThunk ? new _ThunkComposer.ThunkComposer(() => schemaComposer.typeMapper.convertInputTypeDefinition(fc.args[argName].type || fc.args[argName])) : schemaComposer.typeMapper.convertInputTypeDefinition(fc.args[argName].type || fc.args[argName])
        });
      });
      fc.args = args;
    }
...
parentAstNode) {
  ...
  return Object.keys(valueMap).map(valueName => {
    ...
    return {
      ...
      // $FlowFixMe
      astNode: parentAstNode === null || parentAstNode === void 0 ? void 0 : (_parentAstNode$values = parentAstNode.values) === null || _parentAstNode$values === void 0 ? void 0 : _parentAstNode$values.find(v => v.name.value === valueName),
...
function defineInputFieldMap(config, fieldMap, parentAstNode) {
  ...
  for (const fieldName of Object.keys(fieldMap)) {
    ...
    const field = _objectSpread(_objectSpread({}, fieldMap[fieldName]), {}, {
      name: fieldName,
      // $FlowFixMe
      astNode: parentAstNode === null || parentAstNode === void 0 ? void 0 : (_parentAstNode$fields2 = parentAstNode.fields) === null || _parentAstNode$fields2 === void 0 ? void 0 : _parentAstNode$fields2.find(f => f.name.value === fieldName)
    });
